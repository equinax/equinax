...
class TuShareDataSource(BaseDataSource):
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        if not self._api_key:
            raise ValueError("TuShare API key not provided. Set TUSHARE_API_KEY environment variable.")
        ...
        try:
            ...
            for _, row in df.iterrows():
                ...
                records.append({
                    ...
                    'total_mv': Decimal(str(float(total_mv) / 10000)) if total_mv else None,  # 万元 -> 亿元
