    ...
    return EtfPredictionResponse(
        ...
        predictions=[
            EtfPredictionItem(
                ...
                # V2: 5 factor scores
                divergence_score=pred.get("divergence_score") or Decimal("0"),
                rsi_score=pred.get("rsi_score") or Decimal("0"),
                rs_score=pred.get("rs_score") or Decimal("0"),
                momentum_score=pred.get("momentum_score") or Decimal("0"),
                activation_score=pred.get("activation_score") or Decimal("0"),
                # Legacy
                compression_score=pred.get("compression_score") or Decimal("0"),
