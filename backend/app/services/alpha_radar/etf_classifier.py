...
# ==============================================================================
# Sub-category to Shenwan L1 Industry Mapping
# ==============================================================================

# Maps ETF sub_category to sw_industry_l1 for volume aggregation
# None means the sub-category cannot be mapped (cross-border, commodity)
SUB_CATEGORY_TO_INDUSTRY = {
    # 行业 ETF - 直接映射到申万L1行业
    "银行": "银行",
    "证券": "非银金融",
    "券商": "非银金融",
...
def get_industry_for_subcategory(sub_category: str) -> str | None:
    """
    Get the Shenwan L1 industry for an ETF sub-category.

    Args:
        sub_category: ETF sub-category name (e.g., "传媒", "半导体")

    Returns:
        Shenwan L1 industry name, or None if not mappable
    """
    return SUB_CATEGORY_TO_INDUSTRY.get(sub_category)
