...
class ScoringEngine:
    ...
    def _ensure_columns(self, df: pl.DataFrame) -> pl.DataFrame:
        ...
        required_columns = {
            ...
            "doji_score": 0.0,
            "shadow_range_pct": 0.0,
            "turn": 0.0,
            "inertia_momentum_score": 0.0,
            "doji_reversal_score": 0.0,
            "calm_accumulation_score": 0.0,
            "strong_close_score": 0.0,
            "range_squeeze_score": 0.0,
            "oversold_bounce_score": 0.0,
            "decline_exhaustion_score": 0.0,
            "failed_breakdown_score": 0.0,
            "momentum_continuation_score": 0.0,
            "return_60d": 0.0,
            "uptrend_score_60d": 0.0,
